    ...
    <div className="flex flex-col h-full">
      <div className="p-6 border-b">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="font-bold text-lg">SentiBassin AI</h2>
  ...
  useEffect(() => {
    const fetchBassins = async () => {
      ...
      if (!error) {
        ...
        console.error("Error fetching bassins:", error)
      }
    }

    if (user) fetchBassins()
  }, [user])
            ...
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-gray-900">SentiBassin AI</h1>
                    <p className="text-sm text-gray-600">Smart Monitoring for Fish Farms</p>
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <HistorySidebar availableBassins={bassins} />
                <LanguageSwitcher />
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-red-600">
                    {Number.isFinite(totalAlerts) ? totalAlerts : 0}
                  </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {bassin.temperature != null ? `${bassin.temperature.toFixed(1)}°C` : "N/A"}
                          </p>
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {bassin.ph != null ? bassin.ph.toFixed(1) : "N/A"}
                          </p>
